...
public class TwoGFragmentTwoWeekly extends Fragment {
	...
	// ---------------------------------------------------------------------------------------------- //
	    ...
	    //        txtCSSR.setTextColor(color)
	        ...
	        try {
	        	...
	        	txtAVAIL.setText("Available : " + new DecimalFormat("##.##").format((montantAvail/14)) + " %");  // Diviser par 14 pour la moyenne par semaine
			} catch (Exception e) {
