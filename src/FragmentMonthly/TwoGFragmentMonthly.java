...
public class TwoGFragmentMonthly extends Fragment {
	...
	// ---------------------------------------------------------------------------------------------- //
	    ...
	    //        txtCSSR.setTextColor(color)
	        ...
	        try {
	        	...
	        	txtAVAIL.setText("Available : " + new DecimalFormat("##.##").format((montantAvail/30)) + " %");  // Diviser par 7 pour la moyenne par semaine
			} catch (Exception e) {
