...
import FragmentMonthly.FragmentPageAdapterMonthly;
...
public class SliderTabMonthly extends FragmentActivity implements ActionBar.TabListener{

	ActionBar actionBar;
	ViewPager viewPager;
	FragmentPageAdapterMonthly ft;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ft = new FragmentPageAdapterMonthly(getSupportFragmentManager());
		...
		actionBar.setTitle("Daily Perform Monthly");
