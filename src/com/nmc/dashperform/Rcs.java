...
public class Rcs extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		view = getLayoutInflater().inflate(R.layout.activity_rcs,null); 
		setContentView(view);
		lineChart = (LineChart) findViewById(R.id.chartRCS);
		speedometerCDR = (SpeedometerView) findViewById(R.id.speedometerRcsCDR);
		speedometerCSSR = (SpeedometerView) findViewById(R.id.speedometerRcsCSSR);
		speedometerAVAIL = (SpeedometerView) findViewById(R.id.speedometerRcsAVAIL);
		txtCDR = (TextView) findViewById(R.id.txtRcsCDR);
		txtCSSR = (TextView) findViewById(R.id.txtRcsCSSR);
		txtAVAIL = (TextView) findViewById(R.id.txtRcsAVAIL);
		txtDATE = (TextView) findViewById(R.id.txtDateUpdateRCS);
...
//		--------------------------------------------------------------------------------------------
		try {
			...
			if(ninfo != null && ninfo.isConnected()){
				List<Network> listNet = network_KPI.getRCSKPI();
			    int ii = 0;
...
//			    Toast.makeText(getBaseContext(), "ok", Toast.LENGTH_LONG).show();
		...
		// ---------------------------------------------------------------------------------------------- //
		    ...
		    //        txtCSSR.setTextColor(color)
		        ...
		        lineChart.animateY(3000); // Activer l'animation
			} else {
				Toast.makeText(Rcs.this, "Please enable mobile network", Toast.LENGTH_LONG).show();
