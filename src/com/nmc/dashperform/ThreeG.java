...
public class ThreeG extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//setContentView(R.layout.activity_three_g);
		
		view = getLayoutInflater().inflate(R.layout.activity_three_g,null); 
		setContentView(view);
		lineChart = (LineChart) findViewById(R.id.chart3G);
		speedometerCDR = (SpeedometerView) findViewById(R.id.speedometer3gCDR);
		speedometerCSSR = (SpeedometerView) findViewById(R.id.speedometer3gCSSR);
		speedometerAVAIL = (SpeedometerView) findViewById(R.id.speedometer3gAVAIL);
		txtCDR = (TextView) findViewById(R.id.txt3gCDR);
		txtCSSR = (TextView) findViewById(R.id.txt3gCSSR);
		txtAVAIL = (TextView) findViewById(R.id.txt3gAVAIL);
		txtDATE = (TextView) findViewById(R.id.txtDateUpdate3G);
		...
		//		v.setScaleX((float) (x+0.5));
		//		v.setScaleY((float) (y+0.5));
...
//		--------------------------------------------------------------------------------------------
			...
			try {
				...
				if(ninfo != null && ninfo.isConnected()){
					...
					List<Network> listNet = network_KPI.get3gKPI(ThreeG.this);
				    int ii = 0;
			...
			// ---------------------------------------------------------------------------------------------- //
			    ...
			    //        txtCSSR.setTextColor(color)
					...
					Toast.makeText(ThreeG.this, "Please enable mobile network", Toast.LENGTH_LONG).show();
