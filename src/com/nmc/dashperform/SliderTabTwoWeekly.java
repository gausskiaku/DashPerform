...
import FragmentTwoWeekly.FragmentPageAdapterTwoWeekly;
...
public class SliderTabTwoWeekly extends FragmentActivity implements ActionBar.TabListener{

	ActionBar actionBar;
	ViewPager viewPager;
	FragmentPageAdapterTwoWeekly ft;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ft = new FragmentPageAdapterTwoWeekly(getSupportFragmentManager());
		...
		actionBar.setTitle("Daily Perform Two Weekly");
