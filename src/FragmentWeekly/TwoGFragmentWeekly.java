...
public class TwoGFragmentWeekly extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		dateUpdate = (TextView) view.findViewById(R.id.txtDateUpdate);
...
//		--------------------------------------------------------------------------------------------
		...
		try {
			...
			List<Network> listNet = network_KPI.get2GKPI(getActivity());
		    int ii = 0;
	...
	// ---------------------------------------------------------------------------------------------- //
	        ...
	        // For call drop
	        speedometerCDR.setSpeed((montantCDR/7));
	        txtCDR.setText("Call drop : " + new DecimalFormat("##.##").format((montantCDR/7)));
	        //txtCDR.setText(date);
	        ...
	        // For call Setup
	        try {
	        	speedometerCSSR.setSpeed((montantCSSR/7) - 98.83333333333333); // (0.2333333333333334 * 98.25) / 100
	            txtCSSR.setText("Call SSR : " + new DecimalFormat("##.##").format((montantCSSR/7)) + " %");
			} catch (Exception e) {
	    ...
	    //        txtCSSR.setTextColor(color)
	        ...
	        // For AVAIL
	        try {
	        	speedometerAVAIL.setSpeed((montantAvail/7) - 98.33333333333333);
	        	txtAVAIL.setText("Available : " + new DecimalFormat("##.##").format((montantAvail/7)) + " %");  // Diviser par 7 pour la moyenne par semaine
			} catch (Exception e) {
